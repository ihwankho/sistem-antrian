...
<div class="card main-card p-4">
    <div class="d-flex justify-content-between align-items-center mb-4">
        ...
        <a href="{{ route('pelayanan.create') }}" class="btn btn-primary"><i class="material-icons me-2">add</i><span>Tambah Layanan</span></a>
    </div>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="text-center">
                        ...
                        {{-- class="d-inline" adalah class Bootstrap (bukan style inline) dan dibiarkan --}}
