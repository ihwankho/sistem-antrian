...
class DepartemenWebController extends Controller
{
    ...
    public function index()
    {
        try {
            ...
            Log::info('Mengambil data departemen dari: http://localhost:8001/api/departemen-loket');
            
            // Menggunakan hardcode URL untuk mengambil data departemen beserta nama loket
            ...
            if ($departemenResponse->successful()) {
                ...
                Log::info('Data departemen berhasil diambil', ['count' => count($departemens)]);
            } else {
            ...
            return view('departemen.index', ['departemens' => []])
